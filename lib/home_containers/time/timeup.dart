...
class _UploadtimeState extends State<Uploadtime> {
  // bool islap(BuildContext) => MediaQuery.of(context).size.width >= 600;
  // bool ismob(BuildContext) => MediaQuery.of(context).size.width < 600;
                  ...
                  onPressed: () async {
                    ...
                    if (result != null) {
                      ...
                      PDFModel pdfModel = PDFModel(
                          ...
                          filenamee: fileName // Replace with your own PDF title
                          );
                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            title: Text('TimeTable Upload completed'),
                            actions: [
                              TextButton(
                                onPressed: () {
